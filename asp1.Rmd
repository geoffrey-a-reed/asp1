...
```{R, word_correlations_by_sentence}
...
```{R, word_correlations_by_paragraph}
...
```{R, word_correlations_by_section}
...
```{R, declare_colors_and_desaturation}
